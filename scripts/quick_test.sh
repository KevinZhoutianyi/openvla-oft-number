#!/bin/bash
# Quick test script: Train for 100 steps, save final checkpoint, and evaluate
# Usage: bash scripts/quick_test.sh
# Note: Must be run on a GPU node (not login node)

set -e  # Exit on error

echo "======================================================================"
echo "Quick Test: Train 100 steps + Evaluate"
echo "======================================================================"
...
BASE_RESULTS_DIR="${CHECKPOINT_DIR}/base_model_eval"
...
echo ""
echo "Step 2: Training for ${MAX_STEPS} steps..."
echo "----------------------------------------------------------------------"
...
# Use lora_adapter directory for evaluation
...
# Compare results
echo "COMPARISON: Before vs After Training"
echo "======================================================================"
...
"
    ...
    echo ""
    echo "AFTER Training (${MAX_STEPS} steps):"
    echo "----------------------------------------------------------------------"
    python3 -c "
import json
